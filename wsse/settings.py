...
# The duration for which the timestamp is valid. After that duration, the
# timestamp will no longer allow authentication.
...
# List of digest algorithms that are allowed. 
ALLOWED_DIGEST_ALGORITHMS = ['SHA256']

# List of digest algorithms that are not allowed.
